...
class Parser {
    ...
    parseParkingText(text) {
        if (/przypisane miejsce postojowe|prywatne miejsce postojowe|własne miejsce postojowe|miejsce postojowe na wyłączność|miejsce postojowe nr|miejsce parkingowe na wyłączność/i.test(text))
            return true;
